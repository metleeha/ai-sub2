...
file = open(os.path.dirname(__file__) + "/comments.txt", 'a', encoding="utf-8")
# file2 = open(os.path.dirname(__file__) + "/comments2.txt", 'w', encoding="utf-8")
# file3 = open(os.path.dirname(__file__) + "/comments3.txt", 'w', encoding="utf-8")
    ...
    for i in range(iter):
        ...
        for j in range(len(points)):
            ...
            if pint > 5 and pint < 10:
                pos+=1
                file.write(point + "\t" + sprstr[1] + "\t" + sprstr[2] + "\n")
                ...
                # file2.write(point + "\t" + sprstr[1] + "\t" + sprstr[2] + "\n")
            # elif 10:
            #     file3.write(point + "\t" + sprstr[1] + "\t" + sprstr[2] + "\n")
            # else:
            #     neg+=1
            #     file.write(point + "\t" + sprstr[1] + "\t" + sprstr[2] + "\n")
            #     file2.write(point + "\t" + sprstr[1] + "\t" + sprstr[2] + "\n")
